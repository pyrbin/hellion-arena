...
public struct ArenaGhostDeserializerCollection : IGhostDeserializerCollection
{
        ...
        ref DataStreamReader reader, NetworkCompressionModel compressionModel)
    {
        ...
        {
            case 0:
                return GhostReceiveSystem<ArenaGhostDeserializerCollection>.InvokeDeserialize(m_CubeSnapshotDataFromEntity, entity, snapshot, baseline, baseline2,
        ...
        NetworkCompressionModel compressionModel)
    {
        switch (serializer)
        {
            case 0:
                ...
                m_CubeSnapshotDataNewGhosts.Add(GhostReceiveSystem<ArenaGhostDeserializerCollection>.InvokeSpawn<CubeSnapshotData>(snapshot, ref reader, compressionModel));
                break;
            default:
                throw new ArgumentException("Invalid serializer type");
        }
...
public struct EnableArenaGhostReceiveSystemComponent : IComponentData
{}
public class ArenaGhostReceiveSystem : GhostReceiveSystem<ArenaGhostDeserializerCollection>
{
