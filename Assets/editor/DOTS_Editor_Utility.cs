...
public class DOTS_Editor_Utility : MonoBehaviour
{
    ...
    {
        ProjectWindowUtil.CreateScriptAssetFromTemplateFile(COMPONENT_DATA_SCRIPT_PATH, "ComponentData.cs");
    }

    [MenuItem(itemName: "Assets/Create/DOTS/Objects/System", isValidateFunction: false, priority: 2)]
    public static void CreateSimpleSystemScript()
    {
        ProjectWindowUtil.CreateScriptAssetFromTemplateFile(SIMPLE_SYSTEM_SCRIPT_PATH, "SimpleSystem.cs");
    }

    [MenuItem(itemName: "Assets/Create/DOTS/Objects/Job System", isValidateFunction: false, priority: 3)]
    public static void CreateJobSystemScript()
    {
        ProjectWindowUtil.CreateScriptAssetFromTemplateFile(JOB_SYSTEM_SCRIPT_PATH, "ScheduleSystem.cs");
    }
}