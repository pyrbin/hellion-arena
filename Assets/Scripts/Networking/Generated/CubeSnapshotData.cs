...
{
    public uint tick;
    private int TestComponentPlayerId;
    ...
    public int GetTestComponentPlayerId(GhostDeserializerState deserializerState)
    {
        return (int)TestComponentPlayerId;
    }
    public int GetTestComponentPlayerId()
    {
        return (int)TestComponentPlayerId;
    }
    public void SetTestComponentPlayerId(int val, GhostSerializerState serializerState)
    {
        TestComponentPlayerId = (int)val;
    }
    public void SetTestComponentPlayerId(int val)
    {
        TestComponentPlayerId = (int)val;
    }
    ...
    public void PredictDelta(uint tick, ref CubeSnapshotData baseline1, ref CubeSnapshotData baseline2)
    {
        ...
        TestComponentPlayerId = predictor.PredictInt(TestComponentPlayerId, baseline1.TestComponentPlayerId, baseline2.TestComponentPlayerId);
    ...
    {
        changeMask0 = (TestComponentPlayerId != baseline.TestComponentPlayerId) ? 1u : 0;
        ...
        if ((changeMask0 & (1 << 0)) != 0)
            writer.WritePackedIntDelta(TestComponentPlayerId, baseline.TestComponentPlayerId, compressionModel);
        ...
        NetworkCompressionModel compressionModel)
    {
        ...
        if ((changeMask0 & (1 << 0)) != 0)
            TestComponentPlayerId = reader.ReadPackedIntDelta(baseline.TestComponentPlayerId, compressionModel);
        else
            TestComponentPlayerId = baseline.TestComponentPlayerId;
        if ((changeMask0 & (1 << 1)) != 0)
        {
