...
#pragma warning restore 649
        ...
        public ArchetypeChunkComponentType<TestComponent> ghostTestComponentType;
        ...
        public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
        {
            ...
            var ghostTestComponentArray = chunk.GetNativeArray(ghostTestComponentType);
            ...
            for (int entityIndex = 0; entityIndex < ghostEntityArray.Length; ++entityIndex)
            {
                ...
                var ghostTestComponent = ghostTestComponentArray[entityIndex];
                var ghostRotation = ghostRotationArray[entityIndex];
                var ghostTranslation = ghostTranslationArray[entityIndex];
                ghostTestComponent.PlayerId = snapshotData.GetTestComponentPlayerId(deserializerState);
                ...
                ghostTestComponentArray[entityIndex] = ghostTestComponent;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostTestComponentType = GetArchetypeChunkComponentType<TestComponent>(),
...
public partial class CubeGhostSpawnSystem : DefaultGhostSpawnSystem<CubeSnapshotData>
{
    struct SetPredictedDefault : IJobParallelFor
    {
        ...
        {
            if (localPlayerId.Length == 1 && snapshots[index].GetTestComponentPlayerId() == localPlayerId[0].Value)
