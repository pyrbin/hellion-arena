...
// https://github.com/Unity-Technologies/DOTSSample/blob/09543c800c4ab58f061db4a407c3f564dc04f734/Assets/Unity.Sample.Core/Scripts/GameDebug/DebugDraw.cs
public class DebugDraw
{
    ...
    // [BurstDiscard] public static void Prim(sphere sphere, Color color, float duration = 0) {
    // Sphere(sphere.center, sphere.radius, color, duration); }
    //
    // [BurstDiscard] public static void Prim(ray ray, Color color, float duration = 0) {
    ...
    // [BurstDiscard] public static void Prim(capsule capsule, Color color, float duration = 0) {
    // var v = capsule.p2 - capsule.p1; Capsule(capsule.p1 + v * 0.5f, math.normalize(v),
    // capsule.radius, math.length(v) + 2 * capsule.radius, color, duration); }
